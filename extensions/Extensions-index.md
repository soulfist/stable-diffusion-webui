	...
	"extensions": [
		{
			...
			"url": "https://cors.isteed.cc/https://github.com/AUTOMATIC1111/stable-diffusion-webui-aesthetic-gradients",
			"description": "Create an embedding from one or few pictures and use it to apply their style to generated images.",
			"tags": ["script"]
		},
		{
			"name": "Wildcards",
			"url": "https://cors.isteed.cc/https://github.com/AUTOMATIC1111/stable-diffusion-webui-wildcards",
		...
		},
		{
			...
			"url": "https://cors.isteed.cc/https://github.com/adieyal/sd-dynamic-prompts",
		...
		{
			"name": "Dreambooth",
			"url": "https://cors.isteed.cc/https://github.com/d8ahazard/sd_dreambooth_extension",
			"description": "Dreambooth training based on Shivam Shiaro's repo, optimized for lower-VRAM GPUs.",
			"tags": ["script", "tab"]
		},
		{
			"name": "Smart Process",
			"url": "https://cors.isteed.cc/https://github.com/d8ahazard/sd_smartprocess",
		...
		{
			"name": "Image browser",
			"url": "https://cors.isteed.cc/https://github.com/yfszzx/stable-diffusion-webui-images-browser",
			"description": "Provides an interface to browse created images in the web browser.",
			"tags": ["script", "tab"]
		},
		{
			"name": "Inspiration",
			"url": "https://cors.isteed.cc/https://github.com/yfszzx/stable-diffusion-webui-inspiration",
		...
		{
			"name": "Deforum",
			"url": "https://cors.isteed.cc/https://github.com/deforum-art/deforum-for-automatic1111-webui",
		...
		},
		{
			...
			"url": "https://cors.isteed.cc/https://github.com/camenduru/stable-diffusion-webui-artists-to-study",
			"description": "Shows a gallery of generated pictures by artists separated into categories.",
			"tags": ["script", "tab"]
		},
		{
			"name": "Aesthetic Image Scorer",
			"url": "https://cors.isteed.cc/https://github.com/tsngo/stable-diffusion-webui-aesthetic-image-scorer",
		...
		},
		{
			...
			"url": "https://cors.isteed.cc/https://github.com/toshiaki1729/stable-diffusion-webui-dataset-tag-editor",
			"description": "Lets you edit captions in training datasets.",
			"tags": ["script", "tab"]
		},
		{
			"name": "auto-sd-paint-ext",
			"url": "https://cors.isteed.cc/https://github.com/Interpause/auto-sd-paint-ext",
			"description": "Krita Plugin.",
			"tags": ["script"]
		},
		{
			"name": "training-picker",
			"url": "https://cors.isteed.cc/https://github.com/Maurdekye/training-picker",
		...
		{
			"name": "Unprompted",
			"url": "https://cors.isteed.cc/https://github.com/ThereforeGames/unprompted",
		...
		{
			"name": "StylePile",
			"url": "https://cors.isteed.cc/https://github.com/some9000/StylePile",
		...
		},
		{
			...
			"url": "https://cors.isteed.cc/https://github.com/DominikDoom/a1111-sd-webui-tagcomplete",
		...
		},
		{
			...
			"url": "https://cors.isteed.cc/https://github.com/animerl/novelai-2-local-prompt",
		...
		{
			"name": "tokenizer",
			"url": "https://cors.isteed.cc/https://github.com/AUTOMATIC1111/stable-diffusion-webui-tokenizer.git",
			"description": "Adds a tab that lets you preview how CLIP model would tokenize your text.",
			"tags": ["script", "tab"]
		},
		{
			"name": "Latent Mirroring",
			"url": "https://cors.isteed.cc/https://github.com/dfaker/SD-latent-mirroring",
		...
		},
		{
			...
			"url": "https://cors.isteed.cc/https://github.com/CodeExplode/stable-diffusion-webui-embedding-editor.git",
			"description": "Allows you to manually edit textual inversion embeddings using sliders.",
			"tags": ["script", "tab"]
		},
		{
			"name": "seed travel",
			"url": "https://cors.isteed.cc/https://github.com/yownas/seed_travel.git",
		...
		},
		{
			...
			"url": "https://cors.isteed.cc/https://github.com/yownas/shift-attention.git",
		...
		},
		{
			...
			"url": "https://cors.isteed.cc/https://github.com/dustysys/ddetailer.git",
			"description": "An object detection and auto-mask extension for Stable Diffusion web UI.",
			"tags": ["script"]
		},
		{
			"name": "prompt travel",
			"url": "https://cors.isteed.cc/https://github.com/Kahsolt/stable-diffusion-webui-prompt-travel.git",
		...
		},
		{
			...
			"url": "https://cors.isteed.cc/https://github.com/klimaleksus/stable-diffusion-webui-conditioning-highres-fix.git",
		...
		{
			"name": "Randomize",
			"url": "https://cors.isteed.cc/https://github.com/stysmmaker/stable-diffusion-webui-randomize.git",
		...
		{
			"name": "Auto TLS-HTTPS",
			"url": "https://cors.isteed.cc/https://github.com/papuSpartan/stable-diffusion-webui-auto-tls-https.git",
			"description": "Allows you to easily, or even completely automatically start using HTTPS.",
			"tags": ["script"]
		},
		{
			"name": "DreamArtist",
			"url": "https://cors.isteed.cc/https://github.com/7eu7d7/DreamArtist-sd-webui-extension.git",
			"description": "Towards Controllable One-Shot Text-to-Image Generation via Contrastive Prompt-Tuning.",
			"tags": ["script"]
		},
		{
			"name": "WD 1.4 Tagger",
			"url": "https://cors.isteed.cc/https://github.com/toriato/stable-diffusion-webui-wd14-tagger.git",
		...
		{
			"name": "booru2prompt",
			"url": "https://cors.isteed.cc/https://github.com/Malisius/booru2prompt.git",
		...
		{
			"name": "Merge Board",
			"url": "https://cors.isteed.cc/https://github.com/bbc-mc/sdweb-merge-board.git",
			"description": "Multiple lane merge support(up to 10). Save and Load your merging combination as Recipes, which is simple text.",
			"tags": ["script", "tab"]
		},
		{
			"name": "Depth Maps",
			"url": "https://cors.isteed.cc/https://github.com/thygate/stable-diffusion-webui-depthmap-script.git",
		...
		},
		{
			...
			"url": "https://cors.isteed.cc/https://github.com/Extraltodeus/multi-subject-render.git",
		...
		{
			"name": "depthmap2mask",
			"url": "https://cors.isteed.cc/https://github.com/Extraltodeus/depthmap2mask.git",
			"description": "Create masks for img2img based on a depth estimation made by MiDaS.",
			"tags": ["script"]
		},
		{
			"name": "Visualize Cross-Attention",
			"url": "https://cors.isteed.cc/https://github.com/benkyoujouzu/stable-diffusion-webui-visualize-cross-attention-extension.git",
		...
		{
			"name": "DAAM",
			"url": "https://cors.isteed.cc/https://github.com/kousw/stable-diffusion-webui-daam.git",
		...
		{
			"name": "Prompt Gallery",
			"url": "https://cors.isteed.cc/https://github.com/dr413677671/PromptGallery-stable-diffusion-webui.git",
		...
		},
		{
			...
			"url": "https://cors.isteed.cc/https://github.com/tkalayci71/embedding-inspector.git",
		...
		},
		{
			...
			"url": "https://cors.isteed.cc/https://github.com/mcmonkeyprojects/sd-infinity-grid-generator-script.git",
		...
		{
			"name": "NSFW checker",
			"url": "https://cors.isteed.cc/https://github.com/AUTOMATIC1111/stable-diffusion-webui-nsfw-censor.git",
			"description": "Replaces NSFW images with black.",
			"tags": ["script"]
		},
		{
			"name": "Config-Presets",
			"url": "https://cors.isteed.cc/https://github.com/Zyin055/Config-Presets.git",
		...
		},
		{
			...
			"url": "https://cors.isteed.cc/https://github.com/d8ahazard/sd_auto_fix.git",
		...
		},
		{
			...
			"url": "https://cors.isteed.cc/https://github.com/dtlnor/stable-diffusion-webui-localization-zh_CN",
			"description": "Simplified Chinese localization",
			"tags": ["localization"]
		},
		{
			"name": "zh_TW Localization",
			"url": "https://cors.isteed.cc/https://github.com/benlisquare/stable-diffusion-webui-localization-zh_TW",
			"description": "Traditional Chinese localization",
			"tags": ["localization"]
		},
		{
			"name": "ko_KR Localization",
			"url": "https://cors.isteed.cc/https://github.com/36DB/stable-diffusion-webui-localization-ko_KR",
			"description": "Korean localization",
			"tags": ["localization"]
		},
		{
			"name": "es_ES Localization",
			"url": "https://cors.isteed.cc/https://github.com/innovaciones/stable-diffusion-webui-localization-es_ES",
			"description": "Spanish localization",
			"tags": ["localization"]
		},
		{
			"name": "it_IT Localization",
			"url": "https://cors.isteed.cc/https://github.com/Harvester62/stable-diffusion-webui-localization-it_IT",
			"description": "Italian localization",
			"tags": ["localization"]
		},
		{
			"name": "de_DE Localization",
			"url": "https://cors.isteed.cc/https://github.com/Strothis/stable-diffusion-webui-de_DE",
			"description": "German localization",
			"tags": ["localization"]
		},
		{
			"name": "ja_JP Localization",
			"url": "https://cors.isteed.cc/https://github.com/Katsuyuki-Karasawa/stable-diffusion-webui-localization-ja_JP",
			"description": "Japanese localization",
			"tags": ["localization"]
		},
		{
			"name": "pt_BR Localization",
			"url": "https://cors.isteed.cc/https://github.com/M-art-ucci/stable-diffusion-webui-localization-pt_BR",
			"description": "Brazillian portuguese localization",
			"tags": ["localization"]
		},
		{
			"name": "tr_TR Localization",
			"url": "https://cors.isteed.cc/https://github.com/camenduru/stable-diffusion-webui-localization-tr_TR",
			"description": "Turkish localization",
			"tags": ["localization"]
		},
		{
			"name": "no_NO Localization",
			"url": "https://cors.isteed.cc/https://github.com/Cyanz83/stable-diffusion-webui-localization-no_NO",
			"description": "Norwegian localization",
			"tags": ["localization"]
		},
		{
			"name": "old localizations",
			"url": "https://cors.isteed.cc/https://github.com/AUTOMATIC1111/stable-diffusion-webui-old-localizations.git",
